...
import ScoreCardTeaser from '@/app/components/ui/pricing/ScoreCardTeaser'
import Creed from '@/app/components/ui/pricing/Creed'
import Networth from '@/app/components/ui/pricing/Networth'
    ...
    <div id="pricing">    
        <div className="container">
            ...
            <div className="pricing-card featured">
                ...
                <div className="pricing-cta"><a href="#cta" className="btn-primary" style={{width:"100%", textAlign:"center", display:"block"}}>Get Started →</a></div>
            </div>
